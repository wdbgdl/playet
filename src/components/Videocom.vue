<template>
    ...
    <!-- 播放视频 -->
    <div class="content">
        <van-swipe  ref="swipeRef" :initial-swipe="props.playsData.swipeIndex" @drag-end="dragEnd" @drag-start="dragStart"
            ...
            <van-swipe-item  v-for="(item, i) in props.playsData.videos" :key="i">
                ...
                <!-- 选集 -->
                <div @click.stop="handleSelectionOpen()" class="seleted">
                    选集
                </div>
    ...
    <!-- 剧集选集 -->
    <SelectionPopup  :currentPlayData="props.playsData"></SelectionPopup>
...
watch(() => (currentsubEpsId.value), (newValue) => {
...
const handleSelectionOpen = () => {
    ...
    emits('goLink',router.currentRoute.value.query?.id ||1)
}
